...
const linkPrimary =
  "pp-touch inline-flex min-h-11 w-full items-center justify-center rounded-xl bg-[#4749B6] px-4 py-2.5 text-sm font-semibold text-white shadow-sm shadow-[#4749B6]/25 transition hover:bg-[#3d3fa3]";

/** Contenido detallado de un paso de la guía (reutilizable en páginas `/guia/...`). */
export function GuiaPasoBody({
  node,
  openFlowHref,
}: {
